        ...
        >
          <Card2 className="w-full bg-transparent  text-white rounded-xm border border-sky-500 overflow-hidden relative">
            ...
            <div className="gap-16 flex flex-col items-center justify-center py-16 px-28 relative">
              <h2 className={clsx("text-sky-500 text-center font-bold text-3xl")}>
                Why you should choose us?
              </h2>
              <p className={clsx("text-white text-center font-bold text-xl")}>
                We are a decentralized platform that offers an easy and user friendly process to
                create invoices powered by Web3 NFT Technology. <br />
                <br />
                Those invoices can be sold in an open market, increasing your chances to get fast
                capital.
                <br />
                <br />
                If the invoice price is too big for only 1 payment, dont worry about it, with
                DAOFactoring you'll be able to create fractionalized invoices in order to facilitate
                the purchase of invoices by institutional and retail investors.
              </p>
